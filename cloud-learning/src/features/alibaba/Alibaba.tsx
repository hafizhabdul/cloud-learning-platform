...
import { Search, Filter, Cloud, Award, BookOpen, Zap, Globe } from 'lucide-react';
import { alibabaData } from '../../data/alibabaData';

export const Alibaba: React.FC = () => {
  ...
  const filteredServices = alibabaData.services.filter(service => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            <div className="flex justify-center items-center space-x-3 mb-4">
              ...
              <h1 className="text-4xl font-bold">Alibaba Cloud</h1>
            </div>
            <p className="text-xl text-orange-100 max-w-3xl mx-auto">
              Leading cloud platform in Asia-Pacific with comprehensive services for 
          ...
          <div className="flex justify-center mt-8">
            <div className="bg-orange-600 rounded-lg p-1 flex space-x-1">
              {[
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
                <div className="relative flex-1 max-w-md">
                  ...
                  <input
                    type="text"
                    placeholder="Search Alibaba Cloud services..."
                    value={searchTerm}
        ...
        {activeSection === 'learning' && (
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Alibaba Cloud Learning Paths</h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {alibabaData.learningPaths.map(path => (
        ...
        {activeSection === 'certifications' && (
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Alibaba Cloud Certifications</h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {alibabaData.certifications.map(cert => (
        ...
        {activeSection === 'labs' && (
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Alibaba Cloud Practice Labs</h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {alibabaData.practiceLabs.map(lab => (
